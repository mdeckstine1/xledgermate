...
KNOB_ALIASES: Dict[str, str] = {
    ...
    "stale_pending_sell_enabled": "alpha_stale_pending_sell_enabled",
    "stale_pending_sell_max_drift_pct": "alpha_stale_pending_sell_max_drift_pct",
    "stale_pending_sell_max_age_seconds": "alpha_stale_pending_sell_max_age_seconds",
    ...
    "ta_volume_enabled": "alpha_ta_volume_enabled",
    "ta_htf_enabled": "alpha_ta_htf_enabled",
    ...
    "alpha_accumulation_harvest_move_24h_watch_pct": "alpha_accumulation_harvest_move_24h_watch_pct",
    "alpha_accumulation_harvest_pullback_arm_pct": "alpha_accumulation_harvest_pullback_arm_pct",
    "alpha_accumulation_harvest_trim_risk_pct": "alpha_accumulation_harvest_trim_risk_pct",
    ...
    "dip_pullback_arm_pct": "alpha_accumulation_dip_pullback_arm_pct",
    "alpha_accumulation_dip_pullback_arm_pct": "alpha_accumulation_dip_pullback_arm_pct",
    "recycle_after_sell_enabled": "alpha_recycle_after_sell_enabled",
    "alpha_recycle_after_sell_enabled": "alpha_recycle_after_sell_enabled",
    "recycle_buy_offset_pct": "alpha_recycle_buy_offset_pct",
    "alpha_recycle_buy_offset_pct": "alpha_recycle_buy_offset_pct",
    "last_sell_ceiling_enabled": "alpha_last_sell_ceiling_enabled",
    "alpha_last_sell_ceiling_enabled": "alpha_last_sell_ceiling_enabled",
    "trim_stop_at_target": "alpha_trim_stop_at_target",
    "alpha_trim_stop_at_target": "alpha_trim_stop_at_target",
    "dip_waive_bearish_ta": "alpha_dip_waive_bearish_ta",
    "alpha_dip_waive_bearish_ta": "alpha_dip_waive_bearish_ta",
    "powder_ceiling_xrp_equiv": "alpha_powder_ceiling_xrp_equiv",
    "alpha_powder_ceiling_xrp_equiv": "alpha_powder_ceiling_xrp_equiv",
    "powder_ceiling_pct": "alpha_powder_ceiling_pct",
    "alpha_powder_ceiling_pct": "alpha_powder_ceiling_pct",
    "powder_floor_pct": "alpha_reload_min_rlusd_deploy_pct",
    "reload_min_rlusd_deploy_pct": "alpha_reload_min_rlusd_deploy_pct",
    "alpha_reload_min_rlusd_deploy_pct": "alpha_reload_min_rlusd_deploy_pct",
    "drawdown_reload_only_below_floor": "alpha_drawdown_reload_only_below_floor",
    "alpha_drawdown_reload_only_below_floor": "alpha_drawdown_reload_only_below_floor",
...
_KNOB_HINTS: Dict[str, str] = {
    ...
    "take_profit_rr": "Bracket take-profit vs stop distance (R multiple)",
    "alpha_accumulation_harvest_move_24h_watch_pct": "Min +24h move % to start harvest WATCHING",
    "alpha_accumulation_harvest_pullback_arm_pct": "Pullback from 24h high % to ARM harvest trim",
    "alpha_accumulation_harvest_trim_risk_pct": "XRP trim size as % portfolio per harvest tranche",
    "alpha_accumulation_dip_move_24h_arm_pct": "Min −24h net move % (+ bounce) to ARM dip (backup path)",
    ...
    "alpha_accumulation_dip_pullback_arm_pct": "Pullback from 24h high % to ARM dip even if 24h is still green (0=off)",
    "alpha_recycle_after_sell_enabled": "After strength/harvest fill, queue a bid below that sell",
    "alpha_recycle_buy_offset_pct": "Recycle bid this % below last sell / mid",
    "alpha_last_sell_ceiling_enabled": "Block bids at or above last strength-harvest sell (no chase)",
    "alpha_trim_stop_at_target": "Do not place more strength/harvest asks once at/under XRP target",
    "alpha_dip_waive_bearish_ta": "Waive bearish TA veto on dip/recycle/powder-ceiling buys",
    "alpha_powder_ceiling_xrp_equiv": "Legacy absolute ceiling in XRP-eq; ignored when powder_ceiling_pct > 0",
    "alpha_powder_ceiling_pct": "Idle powder above this % of bag (under target) must bid; scales with inventory; 0=use XRP-eq",
    "alpha_reload_min_rlusd_deploy_pct": "Powder floor as % of bag; recycle/dip keep this. Scales with inventory. 0=use XRP-eq fallback",
    "alpha_drawdown_reload_only_below_floor": "Drawdown-reload sells only when powder is under the floor",
