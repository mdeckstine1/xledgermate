...
- **Production MM (VPS):** branch **`Ashigaru-Kaizen`** · `python main.py --mode ws-engine` · HUD **`:8765`** · pure A-S v**2.1.10** · **no** legacy `market_edge_met` gate on this path.
...
- **E2 merged:** WS + pure A-S code and docs live on **both** branches; operator deploys **Ashigaru-Kaizen** for live MM.
