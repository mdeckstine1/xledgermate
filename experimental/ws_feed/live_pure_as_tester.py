...
def _hud_market_payload(runtime: dict, **extra: Any) -> dict[str, Any]:
    ...
    payload = {
        ...
        "sell_edge_gate_active": runtime.get("sell_edge_gate_active"),
        "sell_edge_gate_blocked": runtime.get("sell_edge_gate_blocked"),
        "sell_edge_implied_bps": runtime.get("sell_edge_implied_bps"),
        "sell_edge_gate_reason": runtime.get("sell_edge_gate_reason"),
