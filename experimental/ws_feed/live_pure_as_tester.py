...
def _hud_market_payload(runtime: dict, **extra: Any) -> dict[str, Any]:
    ...
    payload = {
        ...
        "qd_intent": runtime.get("qd_intent"),
        "qd_bid_allowed": runtime.get("qd_bid_allowed"),
        "qd_ask_allowed": runtime.get("qd_ask_allowed"),
        "qd_would_quote": runtime.get("qd_would_quote"),
        "qd_layer_summary": runtime.get("qd_layer_summary"),
        "qd_bid_implied_bps": runtime.get("qd_bid_implied_bps"),
        "qd_ask_implied_bps": runtime.get("qd_ask_implied_bps"),
        "qd_bid_block_reason": runtime.get("qd_bid_block_reason"),
        "qd_ask_block_reason": runtime.get("qd_ask_block_reason"),
        "qd_bid_size_mult": runtime.get("qd_bid_size_mult"),
        "qd_ask_size_mult": runtime.get("qd_ask_size_mult"),
        "peer_lane_count": runtime.get("peer_lane_count"),
        "solo_mode": runtime.get("solo_mode"),
        "posture_reason": runtime.get("posture_reason"),
        "qd_peer_lane_token": runtime.get("qd_peer_lane_token"),
        "qd_book_mode": runtime.get("qd_book_mode"),
        "qd_drift_band": runtime.get("qd_drift_band"),
        "qd_intent_reason": runtime.get("qd_intent_reason"),
        "qd_bid_edge_viable": runtime.get("qd_bid_edge_viable"),
        "qd_ask_edge_viable": runtime.get("qd_ask_edge_viable"),
        "qd_bid_min_edge_bps": runtime.get("qd_bid_min_edge_bps"),
        "qd_ask_min_edge_bps": runtime.get("qd_ask_min_edge_bps"),
        "qd_bid_pause_cause": runtime.get("qd_bid_pause_cause"),
        "qd_ask_pause_cause": runtime.get("qd_ask_pause_cause"),
        "qd_bid_bleeding": runtime.get("qd_bid_bleeding"),
        "qd_ask_bleeding": runtime.get("qd_ask_bleeding"),
        "qd_layer_trace": runtime.get("qd_layer_trace"),
        "qd_hud_version": runtime.get("qd_hud_version"),
        "qd_posture_class": runtime.get("qd_posture_class"),
        "qd_permissions_summary": runtime.get("qd_permissions_summary"),
        "purpose_hud_version": runtime.get("purpose_hud_version"),
        "purpose_at_edge": runtime.get("purpose_at_edge"),
        "purpose_delta_xrp": runtime.get("purpose_delta_xrp"),
        "purpose_buy_capture_xrp": runtime.get("purpose_buy_capture_xrp"),
        "purpose_sell_capture_xrp": runtime.get("purpose_sell_capture_xrp"),
        "purpose_session_skim_xrp": runtime.get("purpose_session_skim_xrp"),
        "purpose_gate_pass": runtime.get("purpose_gate_pass"),
        "purpose_gate_status": runtime.get("purpose_gate_status"),
        "purpose_gate_summary": runtime.get("purpose_gate_summary"),
        "session_baseline_xrp": runtime.get("session_baseline_xrp"),
